...
echo "testing aw_RandomUniform_btest.cpp"
...
g++ aw_RandomUniform_btest.cpp -Wall -I ${BOOST_DIR} -I ${AW_CORE} -l "arachnewarp" -o aw_RandomUniform_btest


./aw_RandomUniform_btest
