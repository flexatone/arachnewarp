...
BOOST_AUTO_TEST_CASE(Output001) {
...
BOOST_AUTO_TEST_CASE(Output002) {
...
BOOST_AUTO_TEST_CASE(Output003) {
...
BOOST_AUTO_TEST_CASE(Output004) {
...
BOOST_AUTO_TEST_CASE(Output005) {
...
// august 18 2010
BOOST_AUTO_TEST_CASE(Output006) {
...
// september 3 2010
BOOST_AUTO_TEST_CASE(Output007) {
    ...
    BOOST_CHECK_EQUAL(gen1->getParameterString(), "Click{rate{Constant{220}}{bpm}amplitude{WaveSine{rate{Constant{5}}{seconds}minimum{Constant{0.1}}maximum{Constant{0.6}}}}}");
    
    GeneratorPtr gen2 = gf.create("panstereo{panleftright{wavesine{rate{2}{sec}min{0}max{1}}}}");
    
    BOOST_CHECK_EQUAL(gen2->getParameterString(), "PanStereo{operand1{Constant{0}}panLeftRight{WaveSine{rate{Constant{2}}{seconds}minimum{Constant{0}}maximum{Constant{1}}}}}");
    
    gen2->setParameter("op1", gen1);
    
    BOOST_CHECK_EQUAL(gen2->getParameterString(), "PanStereo{operand1{Click{rate{Constant{220}}{bpm}amplitude{WaveSine{rate{Constant{5}}{seconds}minimum{Constant{0.1}}maximum{Constant{0.6}}}}}}panLeftRight{WaveSine{rate{Constant{2}}{seconds}minimum{Constant{0}}maximum{Constant{1}}}}}");
    
    // compact form
    BOOST_CHECK_EQUAL(gen2->getParameterString(true), "PanStereo{operand1{Click{rate{220}{bpm}amplitude{WaveSine{rate{5}{seconds}minimum{0.1}maximum{0.6}}}}}panLeftRight{WaveSine{rate{2}{seconds}minimum{0}maximum{1}}}}");
...
// september 18 2010
BOOST_AUTO_TEST_CASE(Output008) {
...
// november 14 2010
BOOST_AUTO_TEST_CASE(Output009) {
...
// november 21 2010
BOOST_AUTO_TEST_CASE(Output010) {
...
// december 19 2010
BOOST_AUTO_TEST_CASE(Output011) {
    ...
    //BOOST_CHECK_EQUAL(gen1->getParameterString(true), "WaveSine{rate{Selector{valueList{360,220,3000}selectionMethod{3}refresh{10}{seconds}}}{frequency}minimum{-0.8}maximum{0.8}}");
...
BOOST_AUTO_TEST_CASE(OutputProblemCase01) {
