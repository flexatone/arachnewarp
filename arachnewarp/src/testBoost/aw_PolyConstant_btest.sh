...
echo "testing aw_PolyConstant_btest.cpp"
...
g++ aw_PolyConstant_btest.cpp -Wall -I ${BOOST_DIR} -I ${AW_CORE} -l "arachnewarp" -o aw_PolyConstant_btest


./aw_PolyConstant_btest
